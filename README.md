...
　まだ完成しておりません。（10月前半ごろ基礎的な機能の実装を完成させる予定です。）
...
　以下はコマンドライン（ターミナル）での操作を前提としています。
 ...
 1. リポジトリをgit cloneしてください。
 2. アプリケーションのルートフォルダ(bukatsu)に移動し、「bundle install」を実行してください。
 3. 「rails db:create」を実行してください。
 4. 「rails s」を実行してください。
 5. ブラウザで 「localhost:3000/」にアクセスしてください。
 6. 初回は「localhost:3000/users/first_user」にアクセスして管理者ユーザーを登録してください。
 7. 終了する際は「Control + C」を入力してください。
